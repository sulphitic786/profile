export const navigations = [
  ...
  { label: 'PAGES', type: 'label' },
  {
    ...
    children: [
      ...
      { name: 'Projects', iconText: '404', path: '/portfolio/projects' },
      { name: 'Services', iconText: '404', path: '/portfolio/services' },
      { name: 'Contact Us', iconText: '404', path: '/portfolio/contact_us' },
    ]
  },
  {
    name: 'Session/Auth',
